    ...
    <>
      ...
      <Flex className="sub-footer">
        <Flex className="newsletter-section">
          ...
          <div className="get-insights-text">Sign up for our newsletter to receive customer advocacy insights</div>
        ...
        <Flex className="company-info">
          ...
          <div className="address">1500 Broadway <br/> New York, NY</div>
        </Flex>
      </Flex>
    </>
  );
